...
platform whose adapter supports message deletion (e.g. a messaging platform), the
...
def _install_fakes(
    ...
    *,
    cleanup_on: bool,
    cleanup_platform: Platform = Platform.EMAIL,
):
...
async def test_messaging_agent_forwards_checkpoint_config(monkeypatch, tmp_path):
    ...
    source = SessionSource(platform=Platform.EMAIL, chat_id="-1001")

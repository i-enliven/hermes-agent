...
def _async_event(delegation_id="deleg_duplicate"):
    return {
        ...
        "session_key": "agent:main:email:dm:12345:678",
...
def _completion_event(*, started_at, session_id="proc_reused"):
    return {
        ...
        "session_key": "agent:main:email:dm:123",
        "platform": "email",
        "chat_type": "dm",
        "chat_id": "123",
...
def test_completion_batches_do_not_cross_conversation_routes():
    ...
    second["session_key"] = "agent:main:email:dm:456"
    second["chat_id"] = "456"
...
def _distinct_async_event(delegation_id, session_key="agent:main:email:dm:12345:678"):
...
def test_same_tick_async_events_for_different_sessions_do_not_coalesce(
    ...
    isolated.put(_distinct_async_event(
        "deleg_route_b", session_key="agent:main:email:dm:99999:678",
    ))

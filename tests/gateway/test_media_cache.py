...
dispatch — plus the generic ``cache_media_bytes`` dispatch.

If any of these fail, downloaded-media filenames changed — that's a
behavioral regression, not a test to update casually.
"""

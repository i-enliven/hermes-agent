...
def do_install(identifier: str, category: str = "", force: bool = False,
    ...
    # metadata.hermes.blueprint block, it is a runnable automation.
    try:
        from tools.blueprints import BlueprintError, blueprint_spec_for_installed
        ...
        if spec is not None:
            ...
            c.print(
                "[dim]You can schedule it any time by asking the agent "

...
def _load_global_auth_store() -> Dict[str, Any]:
    ...
    ``_auth_status_cache``): read_credential_pool() -> load_pool() runs
...
def _auth_store_lock(
    ...
    *,
    ...
    ``_shared_store_lock``, acquire ``_auth_store_lock`` FIRST
...
# Same invalidation contract as _auth_status_cache — the global auth
...
def _prompt_model_selection(
    ...
    try:
        ...
        _upgrade_url = (portal_url or "https://hermes.nousresearch.com").rstrip("/")

...
def build_gateway_parser(
    ...
    gateway_parser = subparsers.add_parser(
        ...
        description="Manage the messaging gateway (Telegram, Discord, Weixin, and more)",
    )
    ...
    gateway_run.add_argument(
        ...
        help=(
            ...
            "automatically redirected to the supervised s6 service (the "
    ...
    proxy_start.add_argument(
        "--provider",
                help="Upstream provider: xai. See `hermes proxy providers`.",
    )
    proxy_start.add_argument(
        "--host",
        default=None,

...
PLATFORMS: OrderedDict[str, PlatformInfo] = OrderedDict([
    ...
    ("msgraph_webhook", PlatformInfo(label="🔄 MSGraph Webhook", default_toolset="hermes-msgraph-webhook")),
    ("teams",        PlatformInfo(label="💬 Teams",        default_toolset="hermes-teams")),
    ("relay",        PlatformInfo(label="🔌 Relay",        default_toolset="hermes-relay")),

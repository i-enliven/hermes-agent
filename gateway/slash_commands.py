...
class GatewaySlashCommandsMixin:
    ...
    def _same_matrix_room(current: SessionSource, origin: Optional[SessionSource]) -> bool:
        # Matrix platform removed — no matrix room sharing applies.
        return False
    ...
    async def _handle_commands_command(self, event: MessageEvent) -> str:
        ...
        # Page size is a surface parameter.
        page_size = 20
        reply = execute_command(
            "commands",
            CommandContext(
    ...
    async def _handle_topic_command(self, event: MessageEvent, args: str = "") -> str:
        """Handle /topic. The Telegram DM topic-session platform was removed
        from this fork, so this command is unavailable."""

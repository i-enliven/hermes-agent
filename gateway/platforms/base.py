...
class BasePlatformAdapter(ABC):
    ...
    async def handle_message(self, event: MessageEvent) -> None:
        ...
        # Telegram topic recovery — Telegram platform removed from this fork.
        needs_topic_recovery = False
            ...
            if response:
                ...
                for _tts_index, _tts_path in enumerate(_tts_paths):
                    try:
                        ...
                        # Telegram TTS caption — Telegram platform removed from this fork.
